...
function ProfilePage({ user, onClose }) {
  return (
    <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(34,197,94,0.10)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
      <div className="card" style={{ minWidth: 320, maxWidth: 360, position: "relative", display: "flex", flexDirection: "column", alignItems: "center", boxShadow: "0 8px 32px rgba(34,197,94,0.13)", borderRadius: 18, padding: "2.2rem 1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 16 }}>
          ...
          <h2 style={{ margin: 0, color: "var(--primary-dark, #15803d)", fontWeight: 800, fontSize: "1.5rem", letterSpacing: "0.01em", fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>Profile</h2>
        </div>
